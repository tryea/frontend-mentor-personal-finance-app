...
export const PotSectionCard = ({ item, index, onEdit, onDelete, onAddMoney }: { item: PotItem; index: number; onEdit: (index: number) => void; onDelete: (index: number) => void; onAddMoney: (index: number) => void }) => {
